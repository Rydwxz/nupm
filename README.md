Changes to this branch represent intended design changes. Changes that have been implemented and tested should be moved from here to the developer branch.
